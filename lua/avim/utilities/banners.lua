---@class avim.utilities.banners
---@field random table
---@field anonvim table
---@field angyskull table
---@field hydra table
---@field krakedking table
---@field sleekraken table
---@field pacman table
---@field threeskulls_big_v1 table
---@field threeskulls_v1 table
---@field areee table
---@field uwu table
---@field samurai table
---@field robots table
---@field arasaka table
---@field arasaka_notype table
---@field apex table
---@field titanfall table
---@field punk table
---@field edgerunner table
---@field lambda table
---@field kaizer table
---@field switch table
