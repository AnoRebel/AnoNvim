      ...
      if ctpcn_ok then
        ctpcn.setup({
          ...
          integrations = {
            ...
            fidget = true,
            gitgutter = true,
            gitsigns = features.git,
            illuminate = true,
            indent_blankline = { enabled = true, colored_indent_levels = true },
            leap = features.search,
            lsp_trouble = true,
            mason = true,
            markdown = true,
            notify = true,
            ...
            neotest = features.tests,
            neotree = features.explorer,
            neogit = features.neogit,
            noice = true,
            -- nvimtree = true,
